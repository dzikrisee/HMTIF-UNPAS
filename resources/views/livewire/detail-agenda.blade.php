<div>
        ...
        <div class="relative w-full h-64 bg-gradient-to-r from-gray-50 to-gray-100">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-start">
                ...
                <div class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-bold text-gray-800 text-left">Detail Kegiatan Agenda</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
           ...
           <!-- Article Header -->
           <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-4">{{ $a->judul_kegiatan }}</h1>
            ...
            <div class="flex items-center text-sm text-gray-600 space-x-4 mb-4">
                <div class="flex items-center">
                    ...
                    <span>{{ $a->divisi->nama_divisi }}</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span>{{ \Carbon\Carbon::parse($a->tanggal_kegiatan)->format('d F Y') }}</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <a href="#" class="text-[#248232] hover:underline">{{ $a->divisi->nama_divisi ?? 'Divisi' }}</a>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="mb-8 overflow-hidden">
                    @if($a->gambar_kegiatan)
                        <img src="{{ asset('storage/' . $a->gambar_kegiatan) }}" alt="{{ $a->judul_kegiatan }}" class="w-full h-80 object-cover transition-transform duration-300 hover:scale-110">
                    @else
                ...
                <div class="prose max-w-none">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="{{ route('detail-divisi', $a->id) }}" class="px-3 py-1 bg-gray-100 text-gray-800 text-sm hover:text-white hover:bg-[#248232]">{{ $a->divisi->nama_divisi ?? 'Divisi' }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-gray-50 p-6  mb-8">
                    ...
                    <ul>
                        @foreach ($agendaTerbaru as $item)
                            <li class="mb-4">
                                <a href="{{ route('detail-agenda', $item->id) }}" class="hover:text-[#248232]">
                                    {{ $item->judul_agenda }}
                                </a>
                            </li>
                        @endforeach
