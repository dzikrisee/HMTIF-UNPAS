                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div class="text-white space-y-4">
                        ...
                        <div class="flex space-x-4 mt-8">
                            <button class="w-10 h-10 flex items-center justify-center border border-white rounded-full text-white hover:bg-white hover:text-[#800000] transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-gray-600 mb-4">
                                Di jurusan SI TUS kurikulumnya sudah mengikuti standar kebutuhan perusahaan. Mahasiswa mendapatkan banyak sekali benefit yg bisa dirasakan ketika kuliah. Salah satunya adalah kesempatan untuk magang di BUMN.
                            </p>
                            <div class="flex items-center space-x-4">
                                <img src="{{ asset('images/BPH-Kahim.png') }}" alt="Foto Alumni" class="w-12 h-12 rounded-full object-cover">
                                <div>
                                    <h4 class="font-bold text-gray-800">Rahmad Andika - Alumni</h4>
                                    <p class="text-sm text-gray-500">Data Engineer at Ericson<br>Singapore</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-gray-600 mb-4">
                                SI bukan hanya sekedar jurusan, tapi tempat dimana petualangan bermula. Saya bisa bertemu teman baru, berinovasi dan benerin bug Dosen-dosennya bukan cuma jago ilmu, tapi jago bikin suasana kelas seru. Serasa jadi fellow tech!
                            </p>
                            <div class="flex items-center space-x-4">
                                <img src="{{ asset('images/BPH-Kahim.png') }}" alt="Foto Alumni" class="w-12 h-12 rounded-full object-cover">
                                <div>
                                    <h4 class="font-bold text-gray-800">Rhevindra - Alumni</h4>
                                    <p class="text-sm text-gray-500">Beasiswa S2 UTM<br>Malaysia</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div class="lg:col-span-7">
                        <div class="relative group">
                            <img src="{{ asset('images/Kominfo1.jpg') }}" alt="Featured Activity" class="w-full h-[400px] object-cover rounded-lg">
                            <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent rounded-b-lg">
                                ...
                                <h3 class="text-2xl font-bold text-white mb-2 group-hover:text-gray-200 transition">
                                    <a href="#">Seminar Nasional Teknologi Informasi: Inovasi untuk Masa Depan</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5 space-y-6">
                        @foreach([
                            [
                                ...
                                'title' => 'Workshop UI/UX Design: Dari Dasar Hingga Profesional',
                                'image' => '/images/Kominfo1.jpg'
                            ],
                            [
                                'date' => 'January 30, 2025',
                                'title' => 'Kuliah Umum: Tantangan dan Peluang Industri 4.0',
                                'image' => '/images/Kominfo1.jpg'
                            ],
                            [
                                'date' => 'January 10, 2025',
                                'title' => 'Pengabdian Masyarakat: Edukasi Literasi Digital',
                                'image' => '/images/Kominfo1.jpg'
                            ]
                        ] as $kegiatan)
                        <div class="flex gap-4 group">
                            <img src="{{ asset($kegiatan['image']) }}" alt="{{ $kegiatan['title'] }}" class="w-32 h-24 object-cover rounded">
                            <div>
                                ...
                                <h4 class="font-semibold text-gray-900 group-hover:text-[#248232] transition">
                                    <a href="#">{{ $kegiatan['title'] }}</a>
                                </h4>
                            </div>
                        </div>
                        <hr class="border-gray-300 mb-8">
