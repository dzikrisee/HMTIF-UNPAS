...
Route::get('/detail-proker/{id}', DetailProker::class)->name('detail-proker');
Route::get('/detail-agenda/{id}', DetailAgenda::class)->name('detail-agenda');
Route::get('/struktur', Struktur::class)->name('struktur');
Route::get('/divisi', Divisi::class)->name('divisi');
Route::get('/detail-divisi/{id}', DetailDivisi::class)->name('detail-divisi');
